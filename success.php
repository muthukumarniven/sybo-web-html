...
if(isset($_POST['submit'])){
    ...
    $secretKey = "6Lf7Av4mAAAAAA90xRInVtkxNr52iSSFVO2FPsvW";
    $url = 'https://www.google.com/recaptcha/api/siteverify?secret=' . urlencode($secretKey) .  '&response=' . urlencode($captcha);
    $response = file_get_contents($url);
    $responseKeys = json_decode($response,true);
    if($responseKeys["success"] && !empty($email)) {

                $to = 'support@lovedones.ai'; 

                $subject = 'Lovedones.ai - Contact Request';  
                $htmlContent = "  
                ...
                // Sender info header  
                $headers .= "From:Lovedones <support@lovedones.ai>"."\r\n";  
...
<link rel="manifest" href="/site.webmanifest">  
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Mulish:ital,wght@0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;0,1000;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900;1,1000&display=swap"
        rel="stylesheet">
    <!-- Bootstrap Css -->
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="mainNav">
                        <div class="navbar-inside">
                            <ul class="navbar-nav me-xl-5">
                                ...
                                <li class="nav-item"><a class="nav-link" href="sample-videos.html">Sample Videos</a></li>
                ...
                <div class="container">
                    <div class="row animate-child">
                        <div class="col-lg-12  justify-content-center align-items-center text-center" >
                            ...
                            <h4> We review every message and get back to you promptly!</h4>
                            <p>Thanks for contacting us!</p>
                            <?php } else{?>
                            <h4>Sorry something went wrong<br>
contact us at: support@lovedones.ai</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="footer-bottom-upper d-md-flex justify-content-md-center align-items-md-center">
                                    <ul class="footer-nav d-flex flex-wrap">
                                        ...
                                        <li class="mx-3"><a href="sample-videos.html">Sample Videos</a></li>
                                ...
                                <div class="footer-bottom-lower d-md-flex justify-content-md-center align-items-md-center">
                                    <a href="index.html" class="footer-logo"><img src="include/images/logo-white.png" alt="Lilua"></a>
